    ...
    var document = window.document,
        ...
        renderTopButtons = function (opts, viewMode) {
            return (
                ...
                "" +
                '<button type="button" class="lightpick__previous-action" data-view-mode="' +
                viewMode +
                '">' +
                opts.locale.buttons.prev +
                "</button>" +
                '<button type="button" class="lightpick__next-action" data-view-mode="' +
                viewMode +
                '">' +
        ...
        renderCalendar = function (el, opts) {
            ...
            for (var i = 0; i < opts.numberOfMonths; i++) {
                ...
                html +=
                    '<h1 class="lightpick__month-title" data-ym="' +
                    day.format("YYYY-MM") +
                    '">' +
                    '<b class="lightpick__month-title-accent">' +
                    day.toDate().toLocaleString(opts.lang, {
                        month: "long",
                    }) +
                    "</b> " +
                    day.format("YYYY") +
        ...
        renderMonthsOfYear = function (el, opts, date) {
            ...
            html +=
                '<h1 class="lightpick__month-title">' + ym.format("YYYY") + "</h1>";
            ...
            for (var i = 1; i <= 12; i++) {
                html +=
                    '<div class="lightpick__month-of-the-year" data-goto-month="' +
                    ym.format("YYYY") +
                    "-" +
                    i +
                    '">' +
                    "<div>" +
                    moment(i, "M").toDate().toLocaleString(opts.lang, {
                        month: "long",
                    }) +
                    "</div>" +
                    "<div>" +
            ...
            self._onMouseDown = function (e) {
                ...
                if (
                    ...
                    if (target.hasAttribute("data-ym")) {
                        var _toolbar = self.el.querySelector(
